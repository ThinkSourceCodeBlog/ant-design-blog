...
module.exports = {
  ...
  routes: {// 这里通过bisheng框架,进行拦截路由,比如:/路径则直接路由到homeTmpl=template/Home/index,而path为index-cn 则路由到homeTmpl
    path: '/',
    ...
    childRoutes: [
      ...
      {
        path: 'docs/react/:children', // 表示拦截docs/react下面的连接资源,然后跳转到contentTmpl
